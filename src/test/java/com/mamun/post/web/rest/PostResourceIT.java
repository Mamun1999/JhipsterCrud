package com.mamun.post.web.rest;
...
import com.mamun.post.IntegrationTest;
import com.mamun.post.domain.Post;
import com.mamun.post.repository.PostRepository;
import com.mamun.post.service.dto.PostDTO;
import com.mamun.post.service.mapper.PostMapper;
...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().title(DEFAULT_TITLE).category(DEFAULT_CATEGORY).description(DEFAULT_DESCRIPTION);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().title(UPDATED_TITLE).category(UPDATED_CATEGORY).description(UPDATED_DESCRIPTION);
        return post;
    }
    ...
    void putExistingPost() throws Exception {
        ...
        updatedPost.title(UPDATED_TITLE).category(UPDATED_CATEGORY).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.category(UPDATED_CATEGORY).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.title(UPDATED_TITLE).category(UPDATED_CATEGORY).description(UPDATED_DESCRIPTION);
